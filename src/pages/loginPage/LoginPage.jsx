              ...
              <div className="form-check form-switch my-7 ml-1 flex items-center">
                <div className="flex items-center h-5">
                  <input
                    ...
                    type="checkbox"
                    value=""
                    className="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-teal-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800"
                  />
                </div>
